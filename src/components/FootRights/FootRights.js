...
import { darkgreen } from 'theme/variables';
import media from 'theme/media';

const MOUSE_OVER = 'footRights/MOUSE_OVER';
const MOUSE_LEAVE = 'footRights/MOUSE_LEAVE';
...
class FootRights extends Component {
  render() {
